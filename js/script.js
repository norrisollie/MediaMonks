    ...
    for (var i = 0; i < sectionNumberArr.length; i++) {
        ...
        if (targetElementDataset === sectionNumberArr[i] || arrowTargetElementDataset === sectionNumberArr[i]) {
            ...
            setTimeout(function() {
                ...
                sections[targetElementDataset || arrowTargetElementDataset].classList.remove("hidden");
                sections[targetElementDataset || arrowTargetElementDataset].classList.add("active");
